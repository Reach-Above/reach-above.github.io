					...
					<section id="one" class="wrapper style1 special">
						<div class="inner">
							...
							<ul class="icons major">
								...
								<li><span class="icon fa-leaf-maple major style2"><span class="label">Canadian</span></span></li>
