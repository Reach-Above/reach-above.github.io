					...
					<section id="one" class="wrapper style1 special">
						<div class="inner">
							...
							<ul class="icons major">
								...
								<li><span class="icon fa-canadian-maple-leaf major style2"><span class="label">Canadian</span></span></li>
					...
					<section id="two" class="wrapper alt style2">
						...
						<section class="spotlight">
							<div class="image"><img src="/Markets/04_WhiteBlack_x3.png" alt="" /></div><div class="content">
								...
								<p>Live in and around Ontario? A local community map can be created for you! Just let me know the town and what colour you'd like - I'll take care of the rest. If there a special place ask for a litle <i class="icon fa-solid fa-heart"></i></p>
							</div>
						</section>
					</section>
