					...
					<section id="two" class="wrapper alt style2">
						<section class="spotlight">
							<div class="image"><img src="/Markets/08_Strava.png" alt="" /></div><div class="content">
								...
								<p>Create your own personal map as a kudos to yourself for the rides, runs and achievements, whether it's been over the Pandemic, a specific year or multiple years. These are custom & personal, made for you and your acheivements. <a href="https://reachabove.ca/LearnMore" class="button fit">Learn More</a></p>
							</div>
						</section>
						<section class="spotlight">
