			...
			<div id="page-wrapper">
				...
				<!-- Two -->
					<section id="two" class="wrapper alt style2">
						...
						<section class="spotlight">
							<div class="image"><img src="https://api.mapbox.com/styles/v1/reachabove/clbzork76001e14s41ksf2ecd.html?title=false&access_token=pk.eyJ1IjoicmVhY2hhYm92ZSIsImEiOiJja2hlenc1a3cwbTloMnByejU3Z3JoMXVjIn0.EojHQhHk73D3XVIXMyXbAg&zoomwheel=false#1.00/42.34/-100.34" title="Monochrome" style="border:none;"/></div><div class="content">
								<h2>Slippy Maps</h2>
