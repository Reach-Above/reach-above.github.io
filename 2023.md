					...
					<section id="two" class="wrapper alt style2">
						...
						<section class="spotlight">
							<div class="image"><img src="/images/BT_x3.png" alt="" /></div><div class="content">
								...
								<p>Live in and around Ontario? A map or maps can be created for you! Just let me know the town and what colour you'd like - I'll take care of the rest. Special place? Add a little <i class="icon fa-solid fa-heart"></i><br /><a href="https://reachabove.ca/LearnMore" class="button fit">Learn More</a></p></p>
							</div>
						</section>
						<section class="spotlight">
